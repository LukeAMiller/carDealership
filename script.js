...
const profitarray =cars.map(profit =>{
    return profit.gross_profit})


const profit2017 =profitarray.reduce((runningTotal,currentValue)=>
runningTotal += currentValue)
console.log(profit2017)
// const totalProfit =cars.gross_profit.reduce((runningTotal,currentValue) =>{
//     runningTotal += currentValue})
